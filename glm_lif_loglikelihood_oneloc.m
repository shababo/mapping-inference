...
function [log_likelihood, grad_ll] = glm_lif_loglikelihood_oneloc(fit_params, responses, covs, params)
...
lambda = dt*params.link(total_filter_out);
d_lambda = dt*params.dlink(total_filter_out);
