 function [prior_params]=initialize_parameters()
...
bounds.delay_sigma=[0.1 10];
    ...
    prior_params.shift_x.dist='normal';
        ...
        prior_params.shift_x.mean=ini_mean;
        prior_params.shift_x.log_sigma=log(ini_sigma);
        
        prior_params.shift_y.dist='normal';
        prior_params.shift_y.type='individual';
        prior_params.shift_y.mean=ini_mean;
        prior_params.shift_y.log_sigma=log(ini_sigma);
        
        prior_params.shift_z.dist='normal';
        prior_params.shift_z.type='individual';
        prior_params.shift_z.mean=ini_mean;
        prior_params.shift_z.log_sigma=log(ini_sigma);
