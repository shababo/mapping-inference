...
stimulate = scatter(Z_dense(:,1),...
    -Z_dense(:,2),...
   etemp*3, 'filled','d');

set(stimulate,'MarkerFaceColor','r');

stimulate2 = scatter(Z_dense(idx,1),...
    -Z_dense(idx,2),...
   30, 'filled','d');
set(stimulate2,'MarkerFaceColor','g');
