...
gamma_current
mpp.assignments
true_connected_cells{iiii} = local_index(find(gamma_current > .01));
gamma_current(find(gamma_current > .01))
tmp = unique([mpp.assignments]);
infered_connections{iiii} = tmp(2:end);
% end
