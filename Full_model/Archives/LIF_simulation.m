...
for i_trial = 1:n_trial
    evoked_cell = randsample(n_cell,n_sim_evoked);
    stimuli_size(i_trial,evoked_cell)= k_basic*rand(n_sim_evoked,1);
end


%% Loading functions and Data generation
%% Data generation
% - Generate one sequence of presynaptic events
% - Generate one sequence of spontaneous event
% - Simulate synaptic failutre
