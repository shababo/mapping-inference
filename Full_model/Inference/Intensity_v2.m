function [M_intensity] = Intensity_v2(stimuli_size, n_stimuli_grid,n_grid_voltage,...
...
for i_cell = 1:n_cell_local
    ...
    stim_cell = stimuli_size(:,i_cell)*k_offset;
            ...
            if k > k_minimum
                ...
                for i_t = 2:n_grid_time
                    ...
                    for i_v = 1:n_grid_voltage
                        ...
                        for i = 1:2
                            pVL_given_I(i_t, i_v, i)=pL_given_V(i,i_v)*temp_II_and_III;
                        end
                    end
                end
