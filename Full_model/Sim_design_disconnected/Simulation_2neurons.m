...
for i_setting = 1:num_sim
    ...
    if i_setting == 1
        gamma_truth = [0.7; 0.6];gain_truth=[0.015; 0.02];
    elseif i_setting == 2
        gamma_truth = [0.7; 0];gain_truth=[0.015; 0.02];
    end
    ...
    for i_seed = 1:num_seed
        ...
        gamma_25_path_optimal=gamma_25_path;
        gamma_75_path_optimal=gamma_75_path;
        gain_25_path_optimal=gain_25_path;
        gain_75_path_optimal=gain_75_path;
%%
...
%%
        ...
        %%
        save(strcat('./matfiles/Oct03/','Sim', num2str(i_setting),'Seed',num2str(i_seed),'Vert.mat'),...
...
for i_setting = 1:num_sim
    ...
    for i_seed = 1:num_seed
        ...
        % Load data
        load(strcat('./matfiles/Oct03/','Sim', num2str(i_setting),'Seed',num2str(i_seed),'Vert.mat'))
...
saveas(1,strcat('./Figures/Oct03/VertSim',num2str(i_setting),'gamma','.png'));
saveas(2,strcat('./Figures/Oct03/VertSim',num2str(i_setting),'gain','.png'));
saveas(3,strcat('./Figures/Oct03/VertSim',num2str(i_setting),'gamma_mse','.png'));
saveas(4,strcat('./Figures/Oct03/VertSim',num2str(i_setting),'gain_mse','.png'));
