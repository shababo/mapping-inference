                ...
                for i = 1:sum(spikes)
                    if rand(1) < params_sim.PR
                        ...
                        if spikes_delay(i)<time_max
                            ...
                            experiment_query_this_group.trials(i_trial).truth.assignments=[experiment_query_this_group.trials(i_trial).truth.assignments this_neighbourhood.neurons(i_cell).cell_ID];
