% Testing scripts
%% 
%Loading the 3d data set
% load('./Environments/l23_cells_lif_glm_fits.mat');
% 
% %%
% l23_cells_first_spike(1).current_data.powers
% %% 
% l23_cells_first_spike(1).current_data.shape_max % shape matrix
% % Third dimension: -90 -50 -20 0 20 50 90
% 
% l23_cells_first_spike(1).current_data.shape_max(6,6,4)
% 
% %%
% histogram(l23_cells_first_spike(1).current_data.shape_max)
% %%
% l23_cells_first_spike(1).current_data.shape_data
% 
% l23_cells_first_spike(1).current_data.power_response
% 
% %% l23_cells_first_spike(1).current_data.current_shape
% 
% %%
% l23_cells_first_spike(1).spike_data
% 
% 
% l23_cells_first_spike(1).intrinsics
% l23_cells_first_spike(1).glm_params
% l23_cells_first_spike(1).V_th
% l23_cells_first_spike(1).gain
% l23_cells_first_spike(1).glm_sim
