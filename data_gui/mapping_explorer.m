...
primary_neurons = neighbourhood.neurons(~get_group_inds(neigbhourhood,'secondary',handles.data.batch_ID));

% max proj of stack
axes(handles.stack_axes) 
plot_max_proj_w_locs(neighbourhood.stack,get_rowmat_from_structarray(...
    primary_neurons,'location'),handles.data.experiment_setup);
