function [X_s, D_s, w_s, gamma_s] = gibbs_single_sweep(X_s, D_s, w_s, gamma_s, Y, pi_nk, c, a, sigma_s, sigma_n, d_mean_nk, d_sigma_nk, t, tau, gmax)
...
[X_s, D_s] = sample_X_and_D(Y,double(X_s),D_s,w_s,pi_nk,d_mean_nk,d_sigma_nk,t,tau,gmax,sigma_n);
X_s = X_s > 0;
toc
...
tic
[M, r] = compute_M_and_r(Y, X_s, D_s, t, tau, gmax, sigma_n, ones(K,1));
toc
