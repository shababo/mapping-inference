% [LNZ,ALPHA,MU,S] = VARBVS_RAND(X,Y,SIGMA,SA,LOGODDS) implements the
...
%
% THIS VERSION OF THE CODE RANDOMIZES THE ORDER EACH PARAMETERS IS UPDATED
% MODIFIED BY: Ben Shababo - 26.12.2012
function [lnZ, alpha, mu, s] = varbvs_rand (X, y, sigma, sa, logodds, options)
