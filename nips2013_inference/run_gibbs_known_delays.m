...
for sample = -B:L
    ...
    [X_s, w_s, gamma_s] = gibbs_single_sweep(X_s, D, w_s, gamma_s, data.responses, pi_nk, c, a, params.sigma_s, params.sigma_n, d_mean_nk, d_sigma_nk, params.t, params.tau, params.g);
