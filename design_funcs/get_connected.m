...
connected_profile.design_func_params.candidate_grid_params.number=[1 5 10];
connected_profile.design_func_params.candidate_grid_params.grid_type='ring'; % ring or random
...
connected_profile.design_func_params.trials_params.num_stim_sites=3;   
...
connected_profile.inference_params.maxit=200;
...
connected_profile.inference_params.step_size_max=0.1;
